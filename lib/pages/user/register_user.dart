...
class _AddUserPageState extends State<AddUserPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.update == true) {
      ...
      textBottom = "Update user";
    } else {
      appTitle = "Crear usuario";
      textBottom = "Crear user";
    }
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        hintText: 'Digite los nombres del usere',
                      ),
                      validator: (value) {
                        if (value!.isEmpty) {
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        labelText: 'Apellidos',
                        border: OutlineInputBorder(),
                        hintText: 'Digite los apellidos del usere',
                      ),
                      validator: (value) {
                        if (value!.isEmpty) {
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        labelText: 'Documento',
                        border: OutlineInputBorder(),
                        hintText: 'Digite el documento del usere',
                      ),
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(
                        labelText: 'Telefono',
                        border: OutlineInputBorder(),
                        hintText: 'Digite el telefono del usere',
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(
                        ...
                        hintText: 'Digite el Correo Electronico del usere',
                      ),
                      validator: (value) {
                        if (value!.isEmpty) {
